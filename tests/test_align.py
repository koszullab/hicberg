...
@pytest.fixture
def hic_build_index(temporary_folder):
    """
...
def hic_build_index_no_fixture(temporary_folder):
    """
    Test if the bowtie2 index is correctly created
    """    
...
def hic_build_index_bowtie2_not_found(monkeypatch):
    """
...
# @pytest.fixture()
# def hic_build_index_genome_not_found(temporary_folder):
#     """
...
def test_hic_align(hic_build_index, temporary_folder):
    """
    ...
    hal.hic_align(index = hic_build_index, fq_for = fq_for_path, fq_rev = fq_rev_path, output_dir = temp_dir_path, verbose = True)
...
def test_hic_view(temporary_folder, hic_build_index, test_hic_align):
    """
...
@pytest.fixture
def hic_sort(temporary_folder, hic_build_index, test_hic_align, test_hic_view):
    """
...
@pytest.mark.skip(reason="legacy test - to be rewritten")
def test_hic_index(temporary_folder, hic_build_index, test_hic_align, test_hic_view, hic_sort):
    """
