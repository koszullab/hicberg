...
def plot_couple_repartition(forward_bam_file : str = "group2.1.rescued.bam", reverse_bam_file : str = "group2.2.rescued.bam",  output_dir : str = None ) -> None:
    ...
    plt.xlabel("Number of the set of possible couples")
    plt.ylabel("Number of occurences")
    plt.title("Distribution of set of potential couple numbers")
    plt.legend()

    plt.savefig(output_path / f"Couple_numbers_distribution.pdf",
        format="pdf",
    )
    plt.close()
